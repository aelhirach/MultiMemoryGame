...
namespace MemoryGame
{
    class AnimalsGate : List<Animal>
    {
        ...
        //Constructor
        public AnimalsGate(List<string> gate)
        {
            foreach (String name in gate)
            {
                foreach (Animal animal in tempGate())
                {
                    if (name == animal.Name)
                    {
                        this.Add(animal);
        ...
        {
            List<Animal> tempGate = new List<Animal>();
            tempGate = tempList();
            tempGate.AddRange(tempGate);
